...
public class LibraryTest {
    ...
    public void testCreateOverdueNotices() {
        ...
        System.out.println(library.getCollection().get(i).dueDate);}
     ...
     * Test method for {@link library.Library#getPatrons(java.lang.String)}
     */
    @Test
    public void testIssueCard() {
        library.open();
        Patron dave = library.issueCard("Dave");
        assertTrue(library.getPatrons().keySet().contains("Dave"));
    ...
    /**
     * Test method for {@link library.Library#okToPrint()}.
     */
    @Test
    public void testOkToPrint() {
    	assertFalse(library.getOkToPrint());
        library.open();
    	assertFalse(library.getOkToPrint());
    }
    ...
    public void testGetCollection() {
    	assertTrue(library.getCollection().contains(this.witches));
    	assertTrue(library.getCollection().contains(this.contact));
        Patron dave = openAndServeDave();
        ArrayList<Book> foundBooks = library.search("Weird Sisters");
        library.checkOut(1);
        assertFalse(library.getCollection().contains(this.sisters));
    }
